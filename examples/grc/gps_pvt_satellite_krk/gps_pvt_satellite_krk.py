...
class gps_pvt_satellite_krk(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "gps_pvt_satellite_krk", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("gps_pvt_satellite_krk")
        ...
        self.settings = Qt.QSettings("GNU Radio", "gps_pvt_satellite_krk")
...
def main(top_block_cls=gps_pvt_satellite_krk, options=None):
