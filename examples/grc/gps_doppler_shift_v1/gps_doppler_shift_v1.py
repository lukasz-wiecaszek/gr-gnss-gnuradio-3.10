...
class gps_doppler_shift_v1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "gps_doppler_shift_v1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("gps_doppler_shift_v1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "gps_doppler_shift_v1")
        ...
        self.qtgui_time_sink_x_0_0_0_0_0.set_y_axis(7000-200, 7000+200)
        ...
        self.gnss_skip_zeros_0 = gnss.skip_zeros()
        self.gnss_signal_normalizer_0 = gnss.signal_normalizer_s16_fc32(1, 12)
        self.gnss_rft_0_0 = gnss.rft()
        self.gnss_rft_0_0.set_transformation(gnss.RFT_ECEF_TO_GCS)
        self.gnss_pvt_0_0 = gnss.pvt(False)
        self.gnss_pseudoranges_decoder_0 = gnss.pseudoranges_decoder(True)
        ...
        self.gnss_number_file_sink_0_0_1_0_0 = gnss.number_file_sink_f64(3, "/dev/null", "\n")
        self.gnss_number_file_sink_0_0_1_0 = gnss.number_file_sink_f64(3, "satellite_velocity_svid_01.dat", "\n")
        self.gnss_number_file_sink_0_0_1 = gnss.number_file_sink_f64(3, "satellite_position_svid_01.dat", "\n")
        self.gnss_number_file_sink_0_0_0 = gnss.number_file_sink_f32(1, "doppler_shift_measured_svid_01.dat", "\n")
        self.gnss_number_file_sink_0_0 = gnss.number_file_sink_f64(1, "doppler_shift_evaluated_svid_01.dat", "\n")
        ...
        self.gnss_geojson_file_sink_1_0 = gnss.geojson_file_sink("default")
        self.gnss_doppler_shift_0 = gnss.doppler_shift(4797643, 166598, 4185421)
        ...
        self.connect((self.gnss_doppler_shift_0, 0), (self.gnss_number_file_sink_0_0, 0))
        ...
        self.connect((self.gnss_pseudoranges_decoder_0, 0), (self.gnss_doppler_shift_0, 0))
        self.connect((self.gnss_pseudoranges_decoder_0, 0), (self.gnss_number_file_sink_0_0_1, 0))
        self.connect((self.gnss_pseudoranges_decoder_0, 4), (self.gnss_number_file_sink_0_0_1_0, 0))
        self.connect((self.gnss_pseudoranges_decoder_0, 7), (self.gnss_number_file_sink_0_0_1_0_0, 2))
        self.connect((self.gnss_pseudoranges_decoder_0, 5), (self.gnss_number_file_sink_0_0_1_0_0, 0))
        self.connect((self.gnss_pseudoranges_decoder_0, 6), (self.gnss_number_file_sink_0_0_1_0_0, 1))
        self.connect((self.gnss_pseudoranges_decoder_0, 1), (self.gnss_pvt_0_0, 1))
        self.connect((self.gnss_pseudoranges_decoder_0, 3), (self.gnss_pvt_0_0, 3))
        self.connect((self.gnss_pseudoranges_decoder_0, 0), (self.gnss_pvt_0_0, 0))
        self.connect((self.gnss_pseudoranges_decoder_0, 2), (self.gnss_pvt_0_0, 2))
        self.connect((self.gnss_pvt_0_0, 0), (self.gnss_skip_zeros_0, 0))
        self.connect((self.gnss_rft_0_0, 0), (self.gnss_geojson_file_sink_1_0, 0))
        self.connect((self.gnss_signal_normalizer_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.gnss_skip_zeros_0, 0), (self.gnss_rft_0_0, 0))
...
def main(top_block_cls=gps_doppler_shift_v1, options=None):
