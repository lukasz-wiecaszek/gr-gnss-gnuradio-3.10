...
class gps_pvt_satellite_bcn(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.gnss_type_converter_0_0_0_0 = gnss.f64_to_f32(1)
        ...
        self.connect((self.gnss_acquisition_and_tracking_0, 1), (self.gnss_type_converter_0_0_0_0, 0))
        ...
        self.connect((self.gnss_type_converter_0_0_0_0, 0), (self.rational_resampler_xxx_0, 0))
