...
class gps_pseudoranges_decoder_v1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "gps_pseudoranges_decoder_v1", catch_exceptions=True)
        ...
        self.gnss_type_converter_0 = gnss.f64_to_f32(3)
        ...
        self.blocks_null_sink_0_0_0_0 = blocks.null_sink(gr.sizeof_float*3)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/home/memyselfandi/projects/sdr-files/gnss/2013_04_04_GNSS_SIGNAL_at_CTTC_SPAIN/2013_04_04_GNSS_SIGNAL_at_CTTC_SPAIN.dat', True, 0, 0)
        ...
        self.connect((self.gnss_pvt_user_0, 0), (self.gnss_type_converter_0, 0))
        self.connect((self.gnss_signal_normalizer_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.gnss_type_converter_0, 0), (self.blocks_null_sink_0_0_0_0, 0))
