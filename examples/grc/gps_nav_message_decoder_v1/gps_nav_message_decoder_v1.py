...
class gps_nav_message_decoder_v1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "gps_nav_message_decoder_v1", catch_exceptions=True)
        ...
        self._delta_f_win = RangeWidget(self._delta_f_range, self.set_delta_f, "delta_f", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.qtgui_time_sink_x_0_0_0_0.set_y_axis(-200000, 200000)
        ...
        self.gnss_type_converter_1 = gnss.f64_to_f32(3)
        ...
        self.gnss_ca_code_generator_0 = gnss.ca_code_generator_fc32(vector_length, samp_rate, svid, gnss.CA_CODE_DOMAIN_FREQUENCY_CONJUGATE)
        self.gnss_acquisition_and_tracking_0_0 = gnss.acquisition_and_tracking(samp_rate, 4.0, 40.0, 2.0, 35.0)
        self.gnss_acquisition_and_tracking_0_0.set_acq_params(gnss.NAVIGATION_SYSTEM_GPS, svid)
        ...
        self.blocks_null_sink_0_0_0 = blocks.null_sink(gr.sizeof_float*3)
        ...
        self.connect((self.gnss_acquisition_and_tracking_0_0, 0), (self.gnss_ca_symbols_to_nav_bits_0, 0))
        self.connect((self.gnss_acquisition_and_tracking_0_0, 0), (self.gnss_type_converter_0, 0))
        self.connect((self.gnss_ca_code_generator_0, 0), (self.blocks_throttle_0_0_0, 0))
        self.connect((self.gnss_ca_symbols_to_nav_bits_0, 0), (self.blocks_unpacked_to_packed_xx_0, 0))
        self.connect((self.gnss_ca_symbols_to_nav_bits_0, 0), (self.gnss_nav_message_decoder_0, 0))
        self.connect((self.gnss_nav_message_decoder_0, 0), (self.gnss_type_converter_1, 0))
        self.connect((self.gnss_signal_normalizer_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.gnss_type_converter_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.gnss_type_converter_1, 0), (self.blocks_null_sink_0_0_0, 0))
