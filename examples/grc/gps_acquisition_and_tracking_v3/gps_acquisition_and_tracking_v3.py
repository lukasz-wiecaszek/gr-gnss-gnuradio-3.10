...
class gps_acquisition_and_tracking_v3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "gps_acquisition_and_tracking_v3", catch_exceptions=True)
        ...
        self.gnss_ca_code_generator_1 = gnss.ca_code_generator_fc32(1, samp_rate, svid, gnss.CA_CODE_DOMAIN_FREQUENCY_CONJUGATE)
        ...
        self.connect((self.blocks_stream_to_vector_0_0, 0), (self.blocks_multiply_xx_1, 1))
