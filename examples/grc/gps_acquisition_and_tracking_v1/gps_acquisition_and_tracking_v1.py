...
class gps_acquisition_and_tracking_v1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "gps_acquisition_and_tracking_v1", catch_exceptions=True)
        ...
        self.gnss_ca_code_generator_1 = gnss.ca_code_generator_fc32(1, samp_rate, svid, gnss.CA_CODE_DOMAIN_TIME)
