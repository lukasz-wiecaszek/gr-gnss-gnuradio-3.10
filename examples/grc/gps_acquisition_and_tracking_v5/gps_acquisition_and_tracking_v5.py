...
class gps_acquisition_and_tracking_v5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "gps_acquisition_and_tracking_v5", catch_exceptions=True)
        ...
        self.qtgui_time_sink_x_0_0_0_0.set_y_axis(6300, 6600)
        ...
        self.gnss_number_file_sink_0 = gnss.number_file_sink_f32(1, "doppler_shift_svid_32.dat", "\n")
        ...
        self.connect((self.gnss_type_converter_0_0, 0), (self.blocks_complex_to_real_0, 0))
